      ...
      <div className="max-w-lg w-full card-flat p-12 text-center">
        ...
        {state === "paid" && (<>
          ...
          <p className="text-[#5C5C5C] mt-3">
            {payload?.metadata?.purchase_type === "credit_pack"
              ? <>Your institute received <b>{payload?.metadata?.credits || 500} AI credits</b>.</>
              : <>Your institute is now on the <b className="capitalize">{payload?.metadata?.plan_id || 'Pro'}</b> plan.</>
            }
          </p>
